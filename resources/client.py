...
self_ip = urllib.request.urlopen('https://v4.ident.me/').read().decode('utf8')
...
socket_send.sendto(b'0', (peer_ip, destination_port))
...
while True:
    msg = input('> ')
    socket_send.sendto(msg.encode(), (peer_ip, source_port))
